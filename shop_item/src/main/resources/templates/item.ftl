...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://192.168.147.130/${goods.gimage}" jqimg="http://192.168.147.130/${goods.gimage}" width="350">
                </div>
                <div id="spec-n5">
        ...
        <div class="shop_goods_show_right">
            ...
            <script type="text/javascript">
                function addCart() {
                    var gid = ${goods.id};
                    var gcount = $("#good_nums").val();
                    location.href = "http://localhost:8086/cartController/addCart?gid="+gid+"&gcount="+gcount;
                }
            </script>
        </div>
    </div>
